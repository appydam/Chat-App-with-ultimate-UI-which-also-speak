...
document.getElementById("mymsg").onsubmit = (e)=>{
  e.preventDefault() 
  insertMessage();  // isse message show kr rha hai DOM pe 
      ...
      console.log("abc",data)
        fetch(url, {
         ...
         serverMessage(response.reply);
          speechSynthesis.speak( new SpeechSynthesisUtterance(response.reply))   // jo computer se awaaz aa rhi thi message ki
